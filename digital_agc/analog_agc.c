...
#ifdef WEBRTC_AGC_DEBUG_DUMP
  fprintf(stt->agcLog, "%5d\t%d\t%d\t%d\t%d\t%d\t%d\n", stt->fcount,
			    stt->digitalAgc.vadNearend.logRatio,
					stt->vadMic.logRatio,
			    inMicLevel,
...
#ifdef WEBRTC_AGC_DEBUG_DUMP
  stt->fpt = fopen("/Users/sparrow/workspace/cpp/agc_spec/spec/release/log/agc_test_log.txt", "wt");
  stt->agcLog = fopen("/Users/sparrow/workspace/cpp/agc_spec/spec/release/log/agc_debug_log.txt", "wt");
  stt->digitalAgc.logFile = fopen("/Users/sparrow/workspace/cpp/agc_spec/spec/release/log/agc_log.txt", "wt");
#endif
