...
#include "base/opensslsessioncache.h"
...
TEST(OpenSSLSessionCache, DISABLE_SimpleValidSessionLookup) {
  SSL_CTX* ssl_ctx = SSL_CTX_new(DTLSv1_2_client_method());
...
TEST(OpenSSLSessionCache, DISABLE_AddToExistingReplacesPrevious) {
  SSL_CTX* ssl_ctx = SSL_CTX_new(DTLSv1_2_client_method());
